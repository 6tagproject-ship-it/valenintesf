...
class GameInfo:
    def __init__(self) -> None:
        self.TitleId:   str = "24276"
        self.SecretKey: str = "S15B1WJAGT1TYQ3MZXFTE15XUOHRXRGZ3YE8A9GS8Z1WHOIS7S"
        self.AppCreds:  str = "OC|1779662489583953|2c0964a1a24cd7f4b4cae75f9707a90d"
        self.OculusAppId: str = "1779662489583953"
        self.EntitlementCheck: bool = False
        self.MothershipJwtSecret: str = "dhujgoldisuhgdslkgjhdslfhdlisukhgdlsugjdspioguhjdspgohadsfoiuashfoaidshgsikjdfldsjfsd"  # Set this to a long random secret string
